...
Symbols below are exported from `@stainless-code/layers` (`packages/core`). React/Preact/Solid/Angular/Vue/Lit re-export the full core. Svelte re-exports selectively — core's headless `createLayer` is `createLayerHandle`.
...
<AutoTypeTable path="../../packages/core/src/types.ts" name="LayerClientOptions" />
...
```ts
function layerOptions<P, R = void, E = DefaultLayerError, D = unknown, RootProps = unknown>(
...
function isPayloadValidationError(value: unknown): value is PayloadValidationError;
```
...
<AutoTypeTable path="../../packages/core/src/types.ts" name="LayerCallContext" />

## LayerComponentProps

Props passed to layer components by adapters when rendering a mounted layer.

<AutoTypeTable path="../../packages/core/src/types.ts" name="LayerComponentProps" />
...
<AutoTypeTable path="../../packages/core/src/types.ts" name="DismissAllOptions" />
