...
- **Devtools + `#dispatch`** — thin `#dispatch` + `StackNotifyEvent` in core; Solid inspector + TanStack React doorbell. Guide: [Devtools](/guides/devtools). Maintainer plan: `docs/plans/devtools-dispatch.md`.
