...
<CardGroup cols={3}>
  ...
  <Card title="Preact" href="/reference/api/preact" icon="/icons/preact.svg" arrow>
  ...
  <Card title="Angular" href="/reference/api/angular" icon="/icons/angular.svg" arrow>
  ...
  <Card title="Svelte (store)" href="/reference/api/svelte-store" icon="/icons/svelte.svg" arrow>
