...
| API names | Identical — `StackProvider`, `useLayerClient`, `useStack`, `useLayer`, `StackOutlet`, `StackSubscribe`, `useStackHandles`, `useMutationFlow`, `useLayerGroup`, `createStackHook` |
