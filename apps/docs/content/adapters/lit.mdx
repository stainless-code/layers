...
Open a confirm from a button in light DOM without threading `open` props through every custom element. Controllers call `requestUpdate`; the core is re-exported.
