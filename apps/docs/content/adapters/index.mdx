...
Name map: Angular `injectLayer` (`useLayer` alias); Svelte `createLayer` / `createLayerState`; Solid also aliases `createLayerState`. Full signatures: [Adapter hooks](/reference/adapter-hooks).
