...
- [#7](https://github.com/stainless-code/layers/pull/7) [`a886aa9`](https://github.com/stainless-code/layers/commit/a886aa93928eee3f51f68e1e63cf729366aecf2e) Thanks [@SutuSebastian](https://github.com/SutuSebastian)! - Add `@stainless-code/lit-layers` — full-matrix Lit adapter (Reactive Controllers, `@lit/context`, light-DOM stack CEs via `defineStackElements()`).
