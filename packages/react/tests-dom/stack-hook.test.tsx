...
import { createStackHook } from "@stainless-code/react-layers";
import type { AppLayerProps } from "@stainless-code/react-layers";
import {
  cleanup,
  fireEvent,
  render,
...
describe("React adapter — createStackHook", () => {
