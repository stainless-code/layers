...
| Capability                                             | React | Preact | Vue | Solid | Angular | Lit | Svelte (runes) | Svelte (store) |
| ------------------------------------------------------ | :---: | :----: | :-: | :---: | :-----: | :-: | :------------: | :------------: |
