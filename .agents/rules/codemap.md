---
description: Query codebase structure via the Codemap SQLite index instead of grep. Use when finding where a symbol is defined, who imports it, listing components/hooks/deprecated symbols, or tracing dependency/call graphs.
alwaysApply: true
---
