...
- **No repo-root `docs/adr/`** — current decisions live in [`docs/architecture.md`](../../../docs/architecture.md); retained audit history in `docs/audits/<topic>.md`; in-flight work in `docs/plans/<name>.md`. See [`docs-governance`](../docs-governance/SKILL.md).
